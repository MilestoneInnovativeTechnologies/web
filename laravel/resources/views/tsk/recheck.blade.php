...
<div class="content">
	<div class="panel panel-default">
		<div class="panel-heading"><strong>Submit task for rechecking</strong>{!! PanelHeadBackButton((url()->previous() == url()->current())?(Route('tsk.index')):(url()->previous())) !!}</div>
		<div class="panel-body clearfix">
			<div class="row">
				<div class="col-md-6"><form method="post">{{ csrf_field() }}
					{!! formGroup(1,'status_text','textarea','Reason for Recheck',['style'	=>	'height:150px', 'attr'	=> 'required']) !!}
