...
<div class="content">
	<div class="row">
		...
		<div class="col-md-8"><form method="post" action="product/{{ $code['code'] }}" onSubmit="return ValidateBaseName()">{{ csrf_field() }}
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Edit</strong><a href="products" class="btn btn-default pull-right btn-sm"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></div>
					...
					<div class="product_create_form">
						<div class="form-group clearfix">
							...
							<div class="col-xs-6">
								...
								<input type="text" class="form-control" id="basename" name="basename" required value="{{ $code['basename'] }}">
							</div>
						</div>
						<div class="form-group clearfix">
							<div class="col-xs-12">
						...
						<div class="form-group clearfix checkbox">
							<div class="col-xs-12">
								<label for="private"><input type="checkbox" name="private" value="YES" id="private"{{ ($code['private'] == "YES")?' checked':'' }}> Private Product (Doesn't publish in Websites)</label>
							</div>
						</div>
						<div class="form-group clearfix">
							<div class="col-xs-12">
