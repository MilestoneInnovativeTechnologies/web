...
<div class="panel panel-default">
	<div class="panel-heading"><strong>{{ $code['name'] }}</strong> (<small>{{ $code['type'] }}</small>)<a href="{{ url()->previous() }}" class="btn btn-default pull-right btn-sm"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></div>
	<div class="panel-body">
		<div class="table-responsive">
			<table class="table table-striped">
				<tbody>
					<tr><td width="15%"><strong>Code</strong></td><td>{{ $code['code'] }}</td></tr>
					<tr><td><strong>Base Name</strong></td><td>{{ $code['base_name'] }}</td></tr>
