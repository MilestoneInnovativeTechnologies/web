...
<div class="table-responsive"><table class="table table-bordered"><thead><tr>
		<th>No</th><th>Customer</th><th>File Details</th>@if(in_array(session()->get('_rolename'),['supportteam','supportagent','company']))<th>Actions</th>@endif
	</tr></thead><tbody>
	@forelse($Dbbs as $Dbb)
	<tr>
		<th>{{ $loop->iteration }}</th>
		<td>{{ $Dbb->Customer->name }}</td>
