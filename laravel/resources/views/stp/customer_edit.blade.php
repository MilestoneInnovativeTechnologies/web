...
<div class="content change_address">
	<form method="post" action="{{ Route('stp.customer.edit',['code'=>$Partner->code]) }}" class="form-horizontal">
	<div class="panel panel-default">
		<div class="panel-heading"><strong>Modify Details</strong><a href="{{ Route('stp.customers') }}" class="btn btn-default pull-right btn-sm"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></div>
