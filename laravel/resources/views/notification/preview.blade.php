...
$(function(){
	Cookies.set('{{ $Data->cookie_name_prefix }}{{ $Data->first()->_GETAUTHUSER()->partner }}.{{ $Data->code }}','{{ $Data->cookie_value }}',{ path: '/', expires: {{ intval(ceil((abs(strtotime($Data->notify_to)-time()))/86400))+1 }} })
})
</script>
@endpush