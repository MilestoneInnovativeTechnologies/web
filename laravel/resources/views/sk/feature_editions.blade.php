...
@section("content")
    <div class="content">
        <div class="panel panel-default">
            <div class="panel-heading"><span style="line-height: 2">{{ $Feature->name }} (<span class="small">{{ $Feature->code }}</span>)</span>{!! PanelHeadBackButton(route('sk.features'),'Back to Features') !!}</div>
