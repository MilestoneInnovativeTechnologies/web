...
<div class="content">
	...
	<div class="row">
		<div class="col col-md-12">
			...
			@component('crd.comp_registration_summary',['Data' => $Registrations]) @endcomponent
			</div></div>
		</div>
		...
		<div class="col col-md-12">
			<div class="panel panel-default"><div class="panel-heading"><div class="panel-title">Active Tickets</div><a href="{{ Route('dealer.tickets') }}" title=" View All Tickets" class="btn btn-default btn-xs pull-right" style="margin-top: -22px;"><span class="glyphicon glyphicon-share-alt"></span>  View All Tickets</a></div><div class="panel-body">
