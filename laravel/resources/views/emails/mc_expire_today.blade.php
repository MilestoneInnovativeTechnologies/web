...
@php $Company = \App\Models\Company::first() @endphp
			...
			<p>Hi {{ $Name }},</p>
			<p>Your Maintenance contract <strong>{{ $Code }}</strong>, for the product <strong>{{ $Product }}</strong>, is <strong><span style="color: #900000">EXPIRING TODAY</span></strong> at <strong>{{ $ExpireTime }}</strong></p>
