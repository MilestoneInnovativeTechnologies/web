...
class CustomerRegistration extends Model
{
	...
	protected $fillable = array('customer', "seqno", 'product', "edition", "presale_enddate", "lic_file", "version", "database", "serialno", "product_id", "key", "registered_on", "remarks", "created_by", "presale_extended_to", "presale_extended_by");
