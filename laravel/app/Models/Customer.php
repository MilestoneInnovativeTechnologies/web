...
class Customer extends Model
{
	...
	public $actions = ['new','panel','edit','presale','resetlogin','changedistributor'];
	public $conditional_action = [];
	public $role_groups = [[],['company'],['distributor','dealer'],['supportagent','supportteam']];
	public $default_group = 0;
	public $group_actions = [0=>[],1=>[0,1,2,3,4,5],2=>[0,1,2,4,5],3=>[0,1,2,3,4,5]];
