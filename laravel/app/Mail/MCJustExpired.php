...
class MCJustExpired extends Mailable
{
    use Queueable, SerializesModels;
		public $Name, $Code, $Product, $StartDate, $EndDate;
		private $To;
    /**
    ...
    public function __construct($Obj)
    {
			...
			$this->set_view_subject("emails.mc_just_expired", "[Milestone] Maintenance Contract Expired.");
    }
