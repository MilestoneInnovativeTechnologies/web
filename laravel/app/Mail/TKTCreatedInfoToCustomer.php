...
class TKTCreatedInfoToCustomer extends Mailable
{
    use Queueable, SerializesModels;
		public $Ticket;
		public $CategoryBreadCrumb, $STAddress;
    ...
    public function __construct($Ticket)
    {
			...
			$this->STAddress = $this->SupportTeamAddress($Ticket->Team->Team->Details);
			
			$this->set_view_subject("emails.tkt_new_to_customer", "[".$this->Ticket->code."] New Support Ticket");
    }
    ...
    public function build()
    {
      return $this->view($this->view)->subject($this->subject);
		...
		private function SupportTeamAddress($D){
			$AdrParts = [];
