...
class TKTCreatedInfoToAll extends Mailable
{
    use Queueable, SerializesModels;
		public $Ticket;
		public $CategoryBreadCrumb, $STAddress, $CAddress;
    ...
    public function __construct($Ticket)
    {
			...
			$this->set_view_subject("emails.tkt_new_to_all", "[".$this->Ticket->code."] New Support Ticket");
    }
