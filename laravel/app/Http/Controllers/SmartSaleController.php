...
{
    static public $Tables = ['setup','fiscalyearmaster','functiondetails','functioninvdetails','function','userprofile','usermaster','userdetails','accountdetails','analysismaster','areamaster','areaaccount','invstoremaster','branchstore','branchmaster','companymaster','companydetails','itemmaster','itemunit','pricelistheader','pricelist','pihdata','piidata','hdata','idata','ddata'];
