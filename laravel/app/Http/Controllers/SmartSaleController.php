...
{
    static public $Tables = ['setup','fiscalyearmaster','functiondetails','functioninvdetails','function','userprofile','usermaster','userdetails','accountdetails','analysismaster','areamaster','areaaccount','invstoremaster','branchstore','branchmaster','companymaster','companydetails','taxruleheader','taxruledetails','itemgroup','itemgroupmaster','itemmaster','itemunit','pricelistheader','pricelist','pihdata','piidata','hdata','idata','billdata','chequedetails','ddata','importreceipts'];
