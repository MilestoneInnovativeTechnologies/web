...
class SmartSaleAssetController extends Controller
{
    private $fields = [
        ...
        'sales_order' => ['docno,store,date,user,customer,fycode,fncode,payment_type,progress,_ref','USER','both','_ref,store,user,date,customer,fycode,fncode,progress'],
        'sales_order_items' => ['so,product,rate,quantity,store,taxrule,tax,discount01,discount02,total,_ref','USER','both','so,product'],
