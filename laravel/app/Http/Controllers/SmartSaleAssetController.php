...
class SmartSaleAssetController extends Controller
{
    private $fields = [
        ...
        'transaction_details' => ['transaction,store,direction,product,quantity,rate,taxrule,tax,discount01,discount02,soi','USER','both','transaction,product,direction,store,shift_docno,soi'],
        'receipts' => ['docno,store,fycode,fncode,mode,customer,date,user,amount,bank,cheque,cheque_date,_ref,source,status','USER','both','docno,store,fycode,fncode,customer,date,user,_ref,shift_docno,status'],
