...
class SmartSaleAssetController extends Controller
{
    private $fields = [
        ...
        'shift' => ['_ref,cocode,brcode,fycode,fncode,docno,user,opening,closing,difference,start_date,end_date,allow_difference,allow_cheque,cancel,status,ssinit','USER','both','fycode,fncode,docno,user,cancel,status'],
        'shift_transactions' => ['shift,fncode,docno,cancel,cash,credit,card,cheque,digitalwallet,ssinit','USER','both','shift,fncode,docno,cancel'],
        ...
        'transaction_details' => ['transaction,store,direction,product,quantity,rate,taxrule,tax,discount01,discount02,soi,shift_docno','USER','both','transaction,product,direction,store,soi'],
        'receipts' => ['docno,store,fycode,fncode,mode,customer,date,user,amount,bank,cheque,cheque_date,_ref,shift_docno,source,status','USER','both','docno,store,fycode,fncode,customer,date,user,_ref,status'],
