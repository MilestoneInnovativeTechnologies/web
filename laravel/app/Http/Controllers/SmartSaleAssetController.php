...
class SmartSaleAssetController extends Controller
{
    private $fields = [
        ...
        'printing' => ['fncode,query1,query2,query3,query1_props,query2_props,query3_props,header1,header2,header3,footer1,footer2,footer3,object,status','APP','download','fncode'],
