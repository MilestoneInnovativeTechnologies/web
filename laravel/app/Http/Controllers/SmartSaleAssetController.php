...
class SmartSaleAssetController extends Controller
{
    private $fields = [
        ...
        'sales_order' => ['docno,date,user,customer,fycode,fncode,payment_type,progress,_ref','USER','both','_ref,user,date,customer,fycode,fncode,progress'],
        'sales_order_items' => ['so,product,rate,quantity,taxrule,tax,discount01,discount02,total,_ref','USER','both','so,product'],
        'transactions' => ['user,docno,date,customer,store,fycode,fncode,payment_type,_ref','USER','both','user,docno,date,customer,store,fycode,fncode,_ref'],
        'transaction_details' => ['transaction,product,quantity,direction,store,taxrule,tax,discount01,discount02,soi','USER','both','transaction,product,direction,store,soi'],
        'receipts' => ['docno,fycode,fncode,mode,customer,date,user,amount,bank,cheque,cheque_date,_ref,status','USER','both','docno,fycode,fncode,customer,date,user,_ref,status'],
