...
class SmartSaleAssetController extends Controller
{
    private $fields = [
        ...
        'functiondetails' => ['code,format,digit_length','APP','download'],
        'product_group_master' => ['name,code,list','APP','download'],
        'products' => ['name,uom,narration,taxfactor,subtaxfactor,taxfactor02,subtaxfactor02','APP','download'],
        ...
        'sales_order_items' => ['so,product,rate,quantity,tax,discount,total,_ref','USER','both'],
        ...
        'transaction_details' => ['transaction,spt,amount,tax,discount,total','USER','both'],
